...
- (UIImageView *)creatImageView{
    ...
    UIImageView *imgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 400, width, height)];
...
- (UIScrollView *)scrollViewWithPosition:(MRImgLocation)imgLocation withImgView:(UIImageView *)imgView{
    ...
    scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(width * imgLocation, -500, width, height+500)];
