...
- (void)layoutSubviews {
    ...
    CGPoint center = CGPointMake(self.bounds.size.width / 3.0, self.bounds.size.height / 32.0);
    CGFloat radius = MIN(self.bounds.size.width, self.bounds.size.height)/3.0 - self.circleLayer.lineWidth / 3.0;
