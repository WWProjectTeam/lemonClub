        ...
        // Checking if group isn't empty
          ...
          if ([[result valueForProperty:ALAssetPropertyType] isEqualToString:ALAssetTypePhoto])
          {
             // UIImage *image = [UIImage imageWithCGImage:[result aspectRatioThumbnail]];
              ...
              //image = [self imageWithImage:image scaledToSize:CGSizeMake(150, 150)];

              
              NSDate *time=[result valueForProperty:ALAssetPropertyDate];
//              NSString *timeStr1=[time stringByReplacingCharactersInRange:NSMakeRange(4, 1) withString:@"年"];
//              NSLog(@"timeStr1---->>>>%@",timeStr1);
//              NSString *timeStr2=[timeStr1 stringByReplacingCharactersInRange:NSMakeRange(7, 1) withString:@"月"];
//              NSLog(@"timeStr2----->>>>>%@",timeStr2);
//              NSString *timeStr3=[timeStr2 stringByReplacingCharactersInRange:NSMakeRange(10, 1) withString:@"日 "];
//              NSLog(@"timeStr3----->>>>>%@",timeStr3);
//              NSString *timeStr4=[timeStr3 stringByReplacingCharactersInRange:NSMakeRange(17, 3) withString:@""];
//              NSLog(@"timeStr4----->>>>>%@",timeStr4);
              
              Media *media=[[Media alloc]init];
              media.media=image;
              media.mediaType=[result valueForProperty:ALAssetPropertyType];
              media.mediaURL=[result valueForProperty:ALAssetPropertyAssetURL];
              media.alasset = result;
              NSDateFormatter *formatter=[[NSDateFormatter alloc] init];
              [formatter setDateFormat:@"dd/MM/yyyy HH:mm:ss"];
              media.dateAndTime=[formatter stringFromDate:time];
          ...
          else if ([[result valueForProperty:ALAssetPropertyType] isEqualToString:ALAssetTypeVideo])
          {
              ...
              AVURLAsset *asset = [[AVURLAsset alloc] initWithURL:[result valueForProperty:ALAssetPropertyAssetURL] options:nil];
              ...
              NSDate *time1 = [result valueForProperty:ALAssetPropertyDate];
              NSDateFormatter *formatter=[[NSDateFormatter alloc] init];
              [formatter setDateFormat:@"dd/MM/yyyy HH:mm:ss"];
              media.dateAndTime = [formatter stringFromDate:time1];
